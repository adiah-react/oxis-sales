  ...
  const handleCheckout = async () => {
    ...
    try {
      ...
      if (useApi) {
        ...
        setSalesHistory([createSale, ...salesHIstory])
        ...
        setSalesHistory([sale, ...saleHistory])
      }
      setShowReceipt(true)
    } catch (err) {
            ...
            <div className="flex gap-2 flex-wrap">
              {categories.map((category) => (
                <button
                  ...
                  className={`px-4 py2 rounded-lg font-medium transition-colors ${
                    selectedCategory === category
                      ? "bg-blue-600 tet-white"
